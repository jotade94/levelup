...
EventimTheme::$boldthemes_page_for_header_id = boldthemes_get_id_by_slug( boldthemes_get_option( 'pf_settings_page_slug' ) );
...
if ( have_posts() ) {
	...
	if ( $categories_html != '' ) {
		$meta_right_html .= '<dt>' . esc_html__( 'Category', 'eventim' ) . '</dt>';
							...
							<div class="rowItemContent">
								...
								<div class="btInfoBar">
									<div class="btInfoBarMeta">
										...
										<p><strong><?php esc_html_e( 'Title:', 'eventim' ); ?></strong> <span class="btPortfolioSliderCaption"></span></p>
										<p><strong><?php esc_html_e( 'Description:', 'eventim' ); ?></strong> <span class="btPortfolioSliderDescription"></span></p>
									</div><!-- /boldInfoBarMeta -->
								</div><!-- /boldInfoBar -->
							</div><!-- /rowItemContent -->
						</div><!-- /rowItem -->
