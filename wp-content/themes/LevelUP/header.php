...
<body <?php body_class( boldthemes_get_body_class() ); ?> data-autoplay="<?php echo intval( boldthemes_get_option( 'autoplay_interval' ) ); ?>" <?php echo wp_kses_post( $body_style ); ?>>
...
<div class="btPageWrap" id="top">
	...
	<div class="btContentWrap btClear">
		<?php if ( EventimTheme::$boldthemes_page_for_header_id != '' && ! is_search() ) { ?>
			<?php
				$content = get_post( EventimTheme::$boldthemes_page_for_header_id );
